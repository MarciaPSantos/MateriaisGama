...
@Table(name="itmn_usuario")		// informo o nome da tabela também
public class Usuario {
	
	@Id							// @Id indica que o atributo é chave-primária
	@GeneratedValue(strategy=GenerationType.IDENTITY)  // informo que é AUTO_INCREMENT
	@Column(name="id_usuario")  // informo o nome da coluna
	private int id;
